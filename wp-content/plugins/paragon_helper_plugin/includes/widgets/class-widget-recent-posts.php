<?php
if(!class_exists('VLThemesRecentPosts'))
{
	class VLThemesRecentPosts extends WP_Widget
	{
		function __construct()
		{
			parent::__construct('VLThemesRecentPosts', esc_html__('VLThemes: Recent Posts', 'vlthemes'), array(
				'description' => esc_html__('Recent Posts Widget', 'vlthemes')
			));
		}
		...
		$title = isset( $instance['title'] ) ? apply_filters( 'widget_title', $instance['title'] ) : '';
			...
			echo '<div class="vl-widget-recent-posts">';
...
add_action('widgets_init', 'register_VLThemesRecentPosts');
if(!function_exists('register_VLThemesRecentPosts'))
{
	function register_VLThemesRecentPosts()
	{
		register_widget('VLThemesRecentPosts');
	}
}
